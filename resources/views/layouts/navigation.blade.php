<nav x-data="{ open: false }" class="bg-white/5 backdrop-blur-md/5 border-b border-white/10 relative z-20">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        <div class="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-accent-teal to-accent-violet rounded-lg shadow-md shadow-accent-teal/30">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-text-muted bg-white/5 hover:text-text-main hover:bg-white/10 focus:outline-none transition ease-in-out duration-150">
